				...
				<div>
					...
					>
						<div class="flex md:space-x-4 justify-between w-full">
							...
							>
							<a
								href="http://egghead.io/instructors/matias-francisco-hernandez-arellano?af=4cexzz"
								name="Egghead"
							>
							...
							<a
								href="https://www.escuelafrontend.com/instructores/matias-hernandez-arellano"
				...
				<div>
					<ul class="mt-4 text-gray-900 dark:text-white">
						...
						<li class="py-1">
							<a
								class="text-secondary hover:text-primary focus:text-primary underlined inline-block whitespace-nowrap text-lg focus:outline-none"
								href="mailto:work@matiashernandez.dev">{$t('common.hire')}</a
							>
						</li>
					</ul>
				</div>

---
date: 2021-22-03T08:00:00.000-03:00
...
tag: Seed
title: Fijando Expectativas ¿Cómo manejar y crear buenas expectativas?
description: La comunicación es una herramienta esencial durante el desarrollo de software y entre las habilidades que debemos desarrollar está el fijar expectativas claras y honestas y sobre todo cumplirlas.
...
> TLDR; Este post es parte del episodio 4 de la segunda temporada de [Café con Tech](https://www.cafecon.tech)
<Buzzsprout buzzsproutId="8182311-fijando-expectativas" />
...
Ya lo comentaba en el [episodio 12 de la temporada anterior](https://www.cafecon.tech/1081172/4452938-4-habilidades-blandas-esenciales-para-un-desarrollador) una de las habilidades esenciales hoy en día es la comunicación, que debe ser clara y efectiva, mejorar en este aspecto te permitirá generar mejores expectativas.
<Buzzsprout buzzsproutId="1081172/4452938-4-habilidades-blandas-esenciales-para-un-desarrollador" />
...
> Definir buenas expectativas de forma temprana puede hacer la diferencia entre un proyecto exitoso y uno fallido.

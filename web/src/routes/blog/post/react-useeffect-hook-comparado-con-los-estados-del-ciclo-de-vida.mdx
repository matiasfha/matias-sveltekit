...
description: |-
  El hook useEffect y los estados del ciclo de vida de un componente.
...
> Relacionado: [Algunos errores comunes al utilizar React hooks](https://matiashernandez.dev/algunos-errores-comunes-al-utilizar-react-hooks)
...
> Relacionado: [¿Qué son los hooks?](https://matiashernandez.dev/que-son-los-hooks)  

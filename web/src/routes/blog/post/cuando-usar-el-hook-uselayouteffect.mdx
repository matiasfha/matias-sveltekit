...
description: "¿Cuándo user el hook useLayoutEffect y cuál es la diferencia con useEffect?"
...
---
<script>
import CodeSandbox from '$lib/components/mdx/CodeSandbox.svelte';
</script>
...
> Relacionado: Hablamos sobre la [lista de dependencie este post](https://matiashernandez.dev/react-useeffect-por-que-el-arreglo-de-dependencias-es-importante)
...
**`useLayoutEffect`** se ejecuta de forma **asíncrona**, justo después de que React ejecutó todas las mutaciones pero antes de "pintar" en pantalla.
...
>
> * [React useEffect hook comparado con los estados del ciclo de vida](https://matiashernandez.dev/react-useeffect-hook-comparado-con-los-estados-del-ciclo-de-vida)

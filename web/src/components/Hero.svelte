...
>
	...
	>
		<div class="flex flex-auto flex-col" style="opacity: 1;">
			<div style="opacity: 1; transform: none;">
				<h1 class="text-3xl md:text-4xl text-black dark:text-white text-center md:text-left p-note">
					{$t('home.presentation')}
				</h1>
			</div>
			...
			>
				<a href="https://twitter.com/matiasfha" rel="me"
					><svg
						width="40px"
						height="40px"
						aria-hidden="true"
				...
				<a href="https://github.com/matiasfha" rel="me">
					<svg
						width="40"
						height="40"
	...
	<div class="mb-12 lg:mb-0 items-center justify-center flex flex-col h-card relative">
		...
		/>
		<div
			class="bg-gradient-to-b dark:from-ebony-clay-300 dark:via-ebony-clay-500 dark:to-ebony-clay-500  from-gray-400 via-gray-200 to-gray-100 z-10 absolute -bottom-8 rounded-xl w-[110%] h-20 blur-lg"
		/>
	</div>
</div>

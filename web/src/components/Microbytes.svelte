			...
			>
				...
				>
					...
					<div class="flex flex-col lg:items-start items-center w-full">
						<h3
							class="text-lg md:text-sm text-green-600 dark:text-green-300 uppercase font-semibold mb-2 font-body text-left -ml-8"
						>
